...
.pull-right[
```{r plot-label-out, ref.label="plot-label", echo=FALSE, fig.height = 5}
```
]
...
.pull-right[
```{r plot-label2-out, ref.label="plot-label2", echo=FALSE, fig.height = 5}
```
]
...
### `kable()` with [reStructuredText](https://docutils.sourceforge.io/rst.html) format 
```{r}
kable(sumbite$coefficients, 
      format = 'rst',
      digits = 3,      # specify number of decimal places to show
